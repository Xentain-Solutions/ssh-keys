...
echo "# Neon Backup NEW" >> ~/.ssh/authorized_keys
echo "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAICmW8DGqLk0X3+Tth0jC/oQwWrVNBu1Vt6CrUb/wfOAU neon" >> ~/.ssh/authorized_keys
echo "# Neon Fido NEW" >> ~/.ssh/authorized_keys
echo "sk-ssh-ed25519@openssh.com AAAAGnNrLXNzaC1lZDI1NTE5QG9wZW5zc2guY29tAAAAIBPx+MAPuE4uzmr66zpd4HsB+TwLI78/3v9KOZMLpX9bAAAAC3NzaDp0ZXJtaXVz Neon" >> ~/.ssh/authorized_keys
