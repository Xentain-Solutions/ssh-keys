...
echo "# Neon Backup" >> ~/.ssh/authorized_keys
echo "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIOZJKRSzvIDB1VJU7EWgSg/qyKDXwrLlZOdEIJE97nGF neon" >> ~/.ssh/authorized_keys
echo "# Neon Fido" >> ~/.ssh/authorized_keys
echo "sk-ssh-ed25519@openssh.com AAAAGnNrLXNzaC1lZDI1NTE5QG9wZW5zc2guY29tAAAAIEBSGpeUxUn15Lv1E7waYo5ORLVk4PS9faiZTeV/dYIUAAAAC3NzaDp0ZXJtaXVz neon" >> ~/.ssh/authorized_keys
